...
extern void Grid_map_subsquare(UArray2_T uarray2, void apply(int i, int j, UArray2_T uarray2, void *p1, void *p2), void *cl, int col, int row);
...
void Grid_map_subsquare(UArray2_T uarray2, void apply(int i, int j, UArray2_T uarray2, void *p1, void *p2), void *cl, int col, int row)
{
        assert(uarray2);
        assert(apply);
